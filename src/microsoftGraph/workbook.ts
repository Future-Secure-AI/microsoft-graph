...
export const listWorksheets = async (
  ref: WorkbookRef,
): Promise<ListWorksheetResponse> =>
  apiGet<ListWorksheetResponse>(
    "/sites/?/drives/?/items/?/workbook/worksheets",
    [ref.site, ref.drive, ref.item],
  );
...
export const deleteWorksheet = async (ref: WorksheetRef): Promise<void> =>
  apiDelete("/sites/?/drives/?/items/?/workbook/worksheets/?", [
    ref.site,
    ref.drive,
    ref.item,
    ref.worksheet,
 ...
 */
export const getUsedRangeValues = async (
  ref: WorksheetRef,
): Promise<WorkbookRange> =>
  apiGet<WorkbookRange>(
    "/sites/?/drives/?/items/?/workbook/worksheets/?/range/usedRange",
    [ref.site, ref.drive, ref.item, ref.worksheet],
  );
 ...
 */
export const getNamedRangeValues = async (
  ref: RangeRef,
): Promise<WorkbookRange> =>
  apiGet<WorkbookRange>("/sites/?/drives/?/items/?/workbook/names/?/range", [
    ref.site,
    ref.drive,
    ref.item,
    ref.range,
 ...
 */
export const setNamedRangeValues = async (
  ref: RangeRef,
  values: RangeValues,
): Promise<void> =>
  apiPatch(
    "/sites/?/drives/?/items/?/workbook/names/?/range",
    [ref.site, ref.drive, ref.item, ref.range],
    values,
  );
