...
export default function updateWorksheet(worksheetRef: WorkbookWorksheetRef, updates: { name?: string; position?: number; visibility?: "Visible" | "Hidden" | "VeryHidden"; }): GraphRequest<WorkbookWorksheet> {
    return {
        method: "PATCH",
